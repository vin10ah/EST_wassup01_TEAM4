...
class MANN(nn.Module):
  def __init__(self, input_dim:int=10, output_dim:int=5, hidden_dim:int=512, c_n:int=2, activation=F.relu, dropout:float=0.3):
    super().__init__()
    ...
    self.batch4 = nn.BatchNorm1d(output_dim)
